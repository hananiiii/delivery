...
export default function (){
    return(
        ...
        <div className="  lg:mt-4  sm:-mt-11 -mt-6 sm:justify-center items-center">
            ...
            <p className=" lg:text-[19px] sm:text-[19px] text-[15px] font-light text-[#1E1E1E] opacity-25 text-center">offering a wide range of services to cater to all your needs<br/> 
        ...
        <div className=" flex   gap-[160px]  items-center justify-center">
            <div className=" rounded-full  w-[340px] h-[340px]  lg:-mt-20 sm:mt-11 mt-11  border-2 border-dashed border-[#E92526] bg-transparent ">
                 <div className="bg-[#e2e2e2]  relative w-[290px] h-[290px] mt-[12px] ml-[4px]   rounded-full">
                    <span className="text-[#FECD0E] text-opacity-100 transform -translate-x-1/2 -translate-y-1/2"><h3 className=" absolute text-[22px] pt-12 pl-[78px] justify-center">Food Delivery</h3></span>
                    <p className="text-[15px] font-light text-[#1E1E1E] text-center pt-[100px] justify-center ">Partnering with restaurants and <br/>
            ...
            <div className="rounded-full w-[340px] h-[340px] mt-[180px]  border-2 border-dashed border-[#FECD0E] bg-transparent hidden lg:block">
                  ...
                  <span className="text-[#E92526] text-opacity-100 transform -translate-x-1/2 -translate-y-1/2"><h3 className=" absolute text-[22px] pt-12 pl-[72px] justify-center">Courier Delivery</h3></span>
                    <p className="text-[15px] font-light text-[#1E1E1E] text-center pt-[100px] justify-center ">Offering fast and reliable courier <br/>
            ...
            <div className="bg-[#e2e2e2]   w-[290px] h-[290px] mt-[12px] ml-[42px] rounded-full">
                    <span className="text-[#FECD0E] text-opacity-100 transform -translate-x-1/2 -translate-y-1/2"><h3 className=" absolute text-[22px] pt-12 pl-[50px] justify-center">E-commerce Delivery</h3></span>
                    <p className="text-[15px] font-light text-[#1E1E1E] text-center pt-[100px] justify-center ">
